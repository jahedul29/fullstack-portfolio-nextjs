...
export default function BlogsPage() {
  ...
  const [editing, setEditing] = React.useState<IBlog | null>(null);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage the blog posts shown on your portfolio.
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      <DataTable
        ...
        emptyMessage="No blogs yet. Add your first one."
      />
      ...
      <ResourceSheet
        ...
        description={
          editing
            ? "Update this blog's details below."
            : "Fill in the details to add a new blog."
        }
      >
        <BlogForm blog={editing} onSuccess={() => setSheetOpen(false)} />
      </ResourceSheet>
      ...
      <ConfirmDelete
        ...
        title="Delete blog?"
        description="This will permanently remove the blog. This action cannot be undone."
      />
    </div>
  );
}
